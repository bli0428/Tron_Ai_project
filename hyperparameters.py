TRAINER_PARAMETERS = {
    ...
    "num_episodes": 200, # Number of games played per iteration (More games = more examples to train on)
    "temp_threshold": 15, # Threshhold for temperature, increasing means spending longer exploring vs exploiting
    "num_games": 40, # How many games to play when comparing bots (Note: this means 20 games per map)
